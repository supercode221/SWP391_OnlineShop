...
<div class="product-feedback-popup">
    <div class="product-feedback-header d-flex justify-content-between align-items-center p-3">
        <h5 class="m-0 text-center flex-grow-1">${requestScope.product.productName}</h5>
        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="product-feedback-body p-3">
        <div class="product-image">
            <img src="${requestScope.product.productThumb}" width="250">
        </div>
        <div class="product-infor">
            <p>${requestScope.product.productDescription}</p>
            <p><strong><fmt:formatNumber value="${requestScope.product.productPrice}" pattern="###,###,###VND"/></strong></p>
        </div>
    </div>
    <div class="product-feedback-body p-3">
    ...
    <div class="product-feedback-footer d-flex justify-content-center pb-5">
        <div class="d-flex flex-column align-items-center">
            ...
            <button id="product-feedback-sent" onclick="getProductDataFeedback()">Thanks For Your Feedback</button>
        </div>
    </div>
</div>
