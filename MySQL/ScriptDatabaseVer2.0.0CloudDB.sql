...
-- -----------------------------------------------------
-- Table `defaultdb`.`changelog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`changelog` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`changelog` (
...
-- -----------------------------------------------------
-- Table `defaultdb`.`role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`role` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`role` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `defaultdb`.`user` (
  ...
  CONSTRAINT `user_ibfk_1`
    ...
    REFERENCES `defaultdb`.`changelog` (`ID`),
  CONSTRAINT `user_ibfk_2`
    FOREIGN KEY (`RoleID`)
    REFERENCES `defaultdb`.`role` (`ID`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `defaultdb`.`address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`address` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`address` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`blog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`blog` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`blog` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `UserID` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`blogmedia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`blogmedia` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`blogmedia` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`cart`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`cart` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`cart` (
  `UserID` INT NULL DEFAULT NULL,
  `ID` INT NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID`),
  INDEX `UserID` (`UserID` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`subcategory`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`subcategory` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`subcategory` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(50) CHARACTER SET 'utf8mb3' NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`product`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`product` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`product` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `product_ibfk_1`
    ...
    REFERENCES `defaultdb`.`subcategory` (`ID`))
ENGINE = InnoDB
AUTO_INCREMENT = 49
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `defaultdb`.`cartproduct`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`cartproduct` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`cartproduct` (
  `CartID` INT NOT NULL,
  ...
  CONSTRAINT `cartproduct_ibfk_1`
    FOREIGN KEY (`CartID`)
    REFERENCES `defaultdb`.`cart` (`ID`),
  CONSTRAINT `cartproduct_ibfk_2`
    FOREIGN KEY (`ProductID`)
    REFERENCES `defaultdb`.`product` (`ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `defaultdb`.`color`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`color` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`color` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`colorproduct`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`colorproduct` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`colorproduct` (
...
-- -----------------------------------------------------
-- Table `defaultdb`.`ShipMethod`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`ShipMethod` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`ShipMethod` (
  `ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`PaymentMethod`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`PaymentMethod` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`PaymentMethod` (
  `ID` INT NOT NULL,
  `Name` VARCHAR(45) NULL,
  PRIMARY KEY (`ID`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `defaultdb`.`bills`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`bills` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`bills` (
  `ID` INT NOT NULL,
  ...
  CONSTRAINT `fk_bills_address1`
    ...
    REFERENCES `defaultdb`.`address` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_bills_ShipMethod1`
    FOREIGN KEY (`ShipMethodID`)
    REFERENCES `defaultdb`.`ShipMethod` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_bills_PaymentMethod1`
    FOREIGN KEY (`PaymentMethodID`)
    REFERENCES `defaultdb`.`PaymentMethod` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `defaultdb`.`order`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`order` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`order` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`feedback`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`feedback` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`feedback` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `UserID` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`feedbackmedia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`feedbackmedia` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`feedbackmedia` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `feedbackmedia_ibfk_1`
    ...
    REFERENCES `defaultdb`.`feedback` (`ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `defaultdb`.`permission`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`permission` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`permission` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`size`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`size` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`size` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`product_color_size`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`product_color_size` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`product_color_size` (
  `ProductID` INT NOT NULL,
  `ColorID` INT NOT NULL,
  `SizeID` INT NOT NULL,
  `Quantity` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`productimage`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`productimage` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`productimage` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `ProductID` INT NULL DEFAULT NULL,
  `Link` VARCHAR(255) NULL DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
-- -----------------------------------------------------
-- Table `defaultdb`.`rolepermission`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`rolepermission` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`rolepermission` (
  `RoleID` INT NOT NULL,
  ...
  CONSTRAINT `rolepermission_ibfk_2`
    ...
    REFERENCES `defaultdb`.`permission` (`ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `defaultdb`.`ShipBrand`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`ShipBrand` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`ShipBrand` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`slider`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`slider` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`slider` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `UserID` INT NULL DEFAULT NULL,
  `Content` TEXT NULL DEFAULT NULL,
...
-- Table `defaultdb`.`tag`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`tag` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`tag` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(50) CHARACTER SET 'utf8mb3' NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`tagproduct`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`tagproduct` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`tagproduct` (
  `TagID` INT NOT NULL,
  `ProductID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`voucher`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`voucher` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`voucher` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `Code` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`wishlistuserproduct`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`wishlistuserproduct` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`wishlistuserproduct` (
  `UserID` INT NOT NULL,
  `ProductID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`Ship_Brand_Method`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`Ship_Brand_Method` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`Ship_Brand_Method` (
  ...
  CONSTRAINT `fk_Ship_Brand_Method_ShipBrand1`
    ...
    REFERENCES `defaultdb`.`ShipBrand` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `defaultdb`.`ship`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `defaultdb`.`ship` ;

CREATE TABLE IF NOT EXISTS `defaultdb`.`ship` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Data for table `defaultdb`.`ShipMethod`
-- -----------------------------------------------------
START TRANSACTION;
USE `defaultdb`;
INSERT INTO `defaultdb`.`ShipMethod` (`ID`, `Name`) VALUES (1, 'Fast Delivery');
INSERT INTO `defaultdb`.`ShipMethod` (`ID`, `Name`) VALUES (2, 'Normal Delivery');
INSERT INTO `defaultdb`.`ShipMethod` (`ID`, `Name`) VALUES (3, 'Economical delivery');

COMMIT;


-- -----------------------------------------------------
-- Data for table `defaultdb`.`PaymentMethod`
-- -----------------------------------------------------
START TRANSACTION;
USE `defaultdb`;
INSERT INTO `defaultdb`.`PaymentMethod` (`ID`, `Name`) VALUES (1, 'VNPay');
INSERT INTO `defaultdb`.`PaymentMethod` (`ID`, `Name`) VALUES (2, 'COD');
INSERT INTO `defaultdb`.`PaymentMethod` (`ID`, `Name`) VALUES (3, 'MoMo');
INSERT INTO `defaultdb`.`PaymentMethod` (`ID`, `Name`) VALUES (4, 'ZaloPay');
INSERT INTO `defaultdb`.`PaymentMethod` (`ID`, `Name`) VALUES (5, 'Banking');

COMMIT;


-- -----------------------------------------------------
-- Data for table `defaultdb`.`ShipBrand`
-- -----------------------------------------------------
START TRANSACTION;
USE `defaultdb`;
INSERT INTO `defaultdb`.`ShipBrand` (`ID`, `Name`) VALUES (1, 'Giao Hàng Tiết Kiệm');
INSERT INTO `defaultdb`.`ShipBrand` (`ID`, `Name`) VALUES (2, 'ShopeeExpress');
INSERT INTO `defaultdb`.`ShipBrand` (`ID`, `Name`) VALUES (3, 'Giao Hàng Nhanh');
INSERT INTO `defaultdb`.`ShipBrand` (`ID`, `Name`) VALUES (4, 'Viettel Post');
INSERT INTO `defaultdb`.`ShipBrand` (`ID`, `Name`) VALUES (5, 'Ninja Van');

COMMIT;


-- -----------------------------------------------------
-- Data for table `defaultdb`.`Ship_Brand_Method`
-- -----------------------------------------------------
START TRANSACTION;
USE `defaultdb`;
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (1, 1);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (1, 2);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (1, 3);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (1, 4);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (2, 1);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (2, 2);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (2, 3);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (2, 4);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (3, 1);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (3, 2);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (3, 3);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (3, 4);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (4, 1);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (4, 2);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (4, 3);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (4, 4);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (5, 1);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (5, 2);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (5, 3);
INSERT INTO `defaultdb`.`Ship_Brand_Method` (`ShipBrandID`, `ShipMethodID`) VALUES (5, 4);
...
ALTER TABLE User
ALTER AvatarImage SET DEFAULT 'https://i.postimg.cc/SRhRPJdX/defaultavatar.jpg'; -- Set default avatar for user 
...
-- Step 1: Add the new columns to the CartProduct table
...
-- Foreign key reference for SizeID
ALTER TABLE CartProduct
ADD CONSTRAINT fk_size
FOREIGN KEY (SizeID)
REFERENCES Size(ID);

-- Foreign key reference for ColorID
ALTER TABLE CartProduct
...
INSERT INTO Cart(UserID, ID) VALUES (?, ?);
INSERT INTO CartProduct(CartID, ProductID, Quantity, SizeID, ColorID) VALUES (?, ?, ?, ?, ?);
...
SELECT EncodedPassword FROM User WHERE ID = 1;
...
FROM
	...
	JOIN Size s ON s.ID = pcs.SizeID
WHERE p.ID = 1
ORDER BY p.ID;
...
SELECT * FROM User WHERE email = 'hoanganh220104@gmail.com';

UPDATE User SET EncodedPassword = '123123' WHERE ID = (SELECT ID FROM User WHERE Email = 'ba@gmail.com');

SET @userID = (SELECT ID FROM User WHERE Email = 'ba@gmail.com');

UPDATE User 
SET EncodedPassword = '123123' 
WHERE ID = @userID;

DELETE FROM User WHERE ID = 87;

ALTER TABLE User
ADD COLUMN Gender NVARCHAR(6);

SELECT * FROM Cart;
SELECT * FROM CartProduct;

SELECT * FROM Address;Slider

DELETE FROM CartProduct WHERE CartID = 4;
DELETE FROM Cart WHERE UserID = 85;

INSERT INTO Slider(UserID, Content, Link) VALUES
(83, 'Dirty Coin Collection', 'https://dosi-in.com/file/detailed/18/share_fb_home.png?w=1200&h=500&fm=webp'),
(83, 'Hades Collection', 'https://theme.hstatic.net/1000306633/1001194548/14/slideshow_2.jpg?v=235');
...
ALTER TABLE Slider
ADD COLUMN BackLink TEXT;

SELECT s.ID, s.Content, s.Link, s.Status FROM Slider s WHERE s.Status = 'active';

UPDATE Slider
SET Link = 'https://bizweb.dktcdn.net/100/369/010/themes/914385/assets/slide-img1.jpg?1727316743604'
WHERE ID = 1;
...
SELECT COUNT(cp.ProductID) AS ProductCount 
                    FROM Cart c 
                    JOIN CartProduct cp ON c.ID = cp.CartID 
                    WHERE c.UserID = 93;
...
p.ThumbnailImage as ProductImage, s.Name as subCategory, t.Name as Tag, t.Color as TagColor
FROM Product p
JOIN SubCategory s ON s.ID = p.SubCategoryID
JOIN TagProduct tp ON tp.ProductID = p.ID
JOIN Tag t ON t.ID = tp.TagID 
WHERE p.Name LIKE ? AND t.Name LIKE ? AND s.Name LIKE ?;

SELECT * FROM User;
SELECT * FROM CartProduct;
SELECT * FROM Cart;
SELECT * FROM WishListUserProduct;

SELECT * FROM Product;
SELECT * FROM TagProduct;
SELECT * FROM Tag;
...
WHERE 
	t.Name LIKE '%Hades%'
		AND s.Name LIKE '%T-Shirt%'WishListUserProduct
		OR p.Name LIKE '%A%';

-- Step 1: Filter by Tag Name
SELECT * 
FROM (
    -- Step 2: Filter by SubCategory Name
    SELECT * 
    FROM (
        -- Step 1: Filter by Tag Name
        ...
        JOIN TagProduct tp ON tp.ProductID = p.ID
        JOIN Tag t ON t.ID = tp.TagID
        WHERE t.Name LIKE '%Hades%'
    ) AS FilteredByTag
    WHERE subCategory LIKE '%T-Shirt%'
) AS FilteredByCategory
...
SELECT 
    ...
    p.Price as ProductPrice,
    p.ThumbnailImage as ProductImage,
    s.Name as SubcateName,
    t.Name as TagName,
    t.Color as ColorCode
FROM 
...
FROM 
    ...
    JOIN Tag t ON t.ID = tp.TagID
WHERE
	p.ID = 1 AND wl.UserID = 84;
    
DELETE FROM WishListUserProduct 
WHERE UserID = 83 AND ProductID = 1;

SELECT * FROM ProductImage WHERE ProductID = 4;
